<?php 
if( !class_exists('vooAddStylesImg') ){
	class vooAddStylesImg{
...
$scripts_list = array(
	...
	'admin' => array(
		array( 'type' => 'script', 'url' => plugins_url('/inc/jscolor/jscolor.js', __FILE__ ), 'enq' => array( 'jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-mouse', 'jquery-ui-slider' ), 'localization' => array(   ) ),
...
$insert_script = new vooAddStylesImg( 'wig' , $scripts_list);
